...
public class XMLTranslator {
	...
	public String generatedcode_Xcode;
	public String generatedcode_Other;
	...
	public void startTranslating() {
		...
		generatedcode_Other = generatedcode_Xcode = "";
		...
		//generating xcode from model
		generatedcode_Xcode = templates.generateXCoreFromModel(mPackage);
		//generating other from model
		generatedcode_Other = templates.generateOtherFromXML(mPackage);
